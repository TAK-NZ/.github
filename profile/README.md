...
| [**ETL-FIRMS**](https://github.com/TAK-NZ/etl-firms)  | Satellite based fire detection | [NASA FIRMS]([https://www.geonet.org.nz/](https://firms.modaps.eosdis.nasa.gov/)) | ✅ | [![Build and Deploy ETL](https://github.com/TAK-NZ/etl-firms/actions/workflows/etl-deploy.yml/badge.svg)](https://github.com/TAK-NZ/etl-firms/actions/workflows/etl-deploy.yml) |
