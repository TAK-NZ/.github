...
| [**ETL-Utils**](https://github.com/TAK-NZ/etl-utils)  | Various utility functions to support other ETLs | N/A | ✅ | [![Build and Deploy ETL](https://github.com/TAK-NZ/etl-utils/actions/workflows/etl-deploy.yml/badge.svg)](https://github.com/TAK-NZ/etl-utils/actions/workflows/etl-deploy.yml) |
